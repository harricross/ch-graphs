...
def export_html(nodes, rels, flat_rows, output_path):
    ...
    tmpl_path = Path(__file__).parent / "templates" / "export.html"
    html = Template(tmpl_path.read_text(encoding="utf-8")).substitute(
        VIS_NODES_JSON=json.dumps(vis_nodes, default=str),
        VIS_EDGES_JSON=json.dumps(vis_edges, default=str),
